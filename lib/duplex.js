...
exports = module.exports = (function(){
	// CONSTRUCTOR
	var base = Stream, proto, klass = function DuplexedStream(writable, readable){
	...
	// STATIC MEMBERS
	klass.DuplexedStream = klass;	// self-reference to make using the Class via Node more obvious
